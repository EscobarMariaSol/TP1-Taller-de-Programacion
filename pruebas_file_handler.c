...
int main(int argc, char *argv[]) {
    ...
    resp = crear_file_handler("Pruebas/prueba_1.txt");
    ...
    resp = usar_file_handler("Pruebas/prueba_1.txt", contenido);
    printf("EL MANEJADOR DE ARCHIVOS DEVUELVE EL CONTENIDO: %s\n", (resp == 0) ? "OK" : "FALLÓ");
